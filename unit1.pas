...
implementation
uses inifiles, LCLIntf, IdGlobal;
{$R *.lfm}
...
//  idftpserver1.DefaultPort:=ini.ReadInteger('Server','Porta',1699);
//  idftpserver1.DefaultDataPort:= idftpserver1.DefaultPort-1;
//  idftpserver1.Bindings.Add.IP:='0.0.0.0:1699';
//  idftpserver1.Bindings.Add.Port:=idftpserver1.DefaultPort;

  idftpserver1.Bindings.Clear;
  idftpserver1.Bindings.Add;
  idftpserver1.Bindings.Items[0].Port:=ini.ReadInteger('Server','Porta',1699);
  idftpserver1.Bindings.Items[0].IP:='127.0.0.1';
  idftpserver1.Bindings.Items[0].IPVersion:=Id_IPv4;
...
begin
  memo1.Lines.Add(datetimetostr(now)+' - Server attivo sulla porta '+inttostr(idftpserver1.Bindings.Items[0].Port));
end;
